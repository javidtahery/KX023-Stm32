...
typedef struct
{
  uint8_t buffer_full_interrupt : 1;
  uint8_t watermark_interrupt : 1;
  uint8_t data_ready_interrupt : 1;
  uint8_t tap_function_interrupt : 1;
  uint8_t wake_up_function_interrupt : 1;
  uint8_t tilt_position_function_interrupt : 1;
